...
opencv_traincascade -data classifier -vec samples.vec -bg increased_negatives.txt -numStages 15 -minHitRate 0.999 -maxFalseAlarmRate 0.25 -numPos 8000 -numNeg 4000 -w 40 -h 40 -mode ALL -precalcValBBufSize 2048 -featureType LBP
